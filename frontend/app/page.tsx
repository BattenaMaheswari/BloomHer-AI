...
<section className="mt-32 px-8">
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div className="bg-white p-6 rounded-2xl shadow-lg">
      <h4 className="text-xl font-bold mb-3">🩺 PCOS Detection</h4>
      <p>Early risk assessment based on symptoms and health patterns.</p>
    </div>

    <div className="bg-white p-6 rounded-2xl shadow-lg">
      <h4 className="text-xl font-bold mb-3">📅 Period Tracking</h4>
      <p>Monitor cycles and predict upcoming periods accurately.</p>
    </div>

    <div className="bg-white p-6 rounded-2xl shadow-lg">
      <h4 className="text-xl font-bold mb-3">🤖 AI Chat</h4>
      <p>Ask questions about menstrual health, PCOS, thyroid, and wellness.</p>
    </div>

    <div className="bg-white p-6 rounded-2xl shadow-lg">
      <h4 className="text-xl font-bold mb-3">🥗 Diet & Yoga</h4>
      <p>Receive personalized wellness recommendations.</p>
    </div>
